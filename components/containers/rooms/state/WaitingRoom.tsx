                        ...
                        {roomInfo.activeRoom.admin === userInfo.info._id ? (
                            <>
                                ...
                                <button
                                    ...
                                    onClick={() => {if(roomInfo.roomUsers.filter((user: RoomUser) => user.roomId === id).length > 1){startGame(id, userInfo.token, dispatch)}else{dispatch(setNotification({type: "error", message: "There should be at least 2 people in this room!"}))}}}
                                >
                                    Start game
                                </button>
                            </>
