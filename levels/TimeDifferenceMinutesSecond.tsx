...
const TimeDifferenceMinutesSecond: React.FC<Props> = ({needHelp, setNeedHelp, multiplayer}) => {
                ...
                <div className="level__container__tip">
                    <div className="level__container__tip__inner">
                        ...
                        <div className="level__container__tip__inner__text">
                            <p>Start by dividing minutes by 60 to get the hours, then multiply the result by the hourly rate.</p>
                        </div>
