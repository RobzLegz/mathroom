...
const TimeAccelerationDistance: React.FC<Props> = ({needHelp, setNeedHelp, multiplayer}) => {
                ...
                <div className="level__container__tip">
                    <div className="level__container__tip__inner">
                        ...
                        <div className="level__container__tip__inner__text">
                            <p>Vo - starting speed of movement; a - acceleration of movement / s2; s - distance; t - movement time, s; Put the numbers in the formula accordingly.</p>
                        </div>
...
export default TimeAccelerationDistance
