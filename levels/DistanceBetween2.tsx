...
const DistanceBetween2: React.FC<Props> = ({needHelp, setNeedHelp, multiplayer}) => {
        ...
        <form className="level__age level__container">
                ...
                <div className="level__container__tip">
                    <div className="level__container__tip__inner">
                        ...
                        <div className="level__container__tip__inner__text">
                            <img src="/levels/instructions/DistanceBetween2.svg" alt="formula for calculating time" />
            ...
            <div className="level__container__options">
                ...
                <div className="level__container__options__ilustration">
                    <img src="/levels/bike_and_motorbike.png" alt="bike and motorbike driving towards each other" />
                </div>
            </div>
        </form>
    )
